package de.ozhan.burak.android.vergissmeinnicht.service;
...
public class VergissmeinnichtService extends Service {
	private NotificationManager mNM;

	// Unique Identification Number for the Notification.
	// We use it on Notification start, and to cancel it.
	private int NOTIFICATION = 273;
	...
	public class LocalBinder extends Binder {
		VergissmeinnichtService getService() {
			return VergissmeinnichtService.this;
		}
	}
